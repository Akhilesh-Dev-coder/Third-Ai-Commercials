...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[550px] bg-gradient-to-tr from-[#ff2751]/20 via-[#e722ff]/12 to-transparent rounded-full blur-[170px] pointer-events-none" />
      <div className="absolute bottom-12 right-12 w-[400px] h-[400px] bg-brand-red/10 rounded-full blur-[140px] pointer-events-none" />

      {/* ── Vignette Overlays ── */}
      <div
        className="absolute inset-0 z-[1] pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse 90% 80% at 50% 35%, transparent 30%, rgba(6,6,8,0.45) 70%, rgba(6,6,8,0.95) 100%)'
        }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
        ...
        <div
          className={`inline-flex items-center gap-2.5 px-4 sm:px-5 py-2 rounded-full border border-[#ff2751]/40 bg-[#ff2751]/[0.08] backdrop-blur-xl text-[#ff3b61] font-mono text-[10px] sm:text-xs uppercase tracking-[0.24em] sm:tracking-[0.28em] mb-6 sm:mb-8 shadow-[0_0_30px_rgba(255,39,81,0.2)] transition-all duration-700 ${
        ...
        {/* Main Headline */}
        <h1
          className={`font-display font-black text-white leading-[1.02] tracking-tight max-w-5xl transition-all duration-700 delay-100 text-[clamp(34px,7.8vw,88px)] mb-5 sm:mb-8 ${
            loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
        ...
        {/* Subtitle */}
        <p
          className={`text-gray-300 font-light max-w-3xl leading-relaxed text-sm sm:text-2xl mb-6 sm:mb-12 transition-all duration-700 delay-200 ${
            loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
        ...
        {/* CTAs */}
        <div
          className={`flex flex-col sm:flex-row items-center gap-4 transition-all duration-700 delay-300 mb-14 sm:mb-20 w-full sm:w-auto ${
            loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
          <a
            href="#contact"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#ff2751] via-[#ff4268] to-[#e722ff] text-white font-bold text-sm sm:text-lg px-8 sm:px-9 py-3.5 sm:py-4 rounded-full shadow-[0_0_35px_rgba(255,39,81,0.45)] hover:shadow-[0_0_55px_rgba(255,39,81,0.7)] hover:scale-105 active:scale-95 transition-all duration-300"
          >
          ...
          <a
            href="#work"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/15 hover:border-white/30 text-white font-semibold text-sm sm:text-lg px-7 sm:px-8 py-3.5 sm:py-4 rounded-full backdrop-blur-md transition-all duration-300 active:scale-95"
          >
            ...
            {airedChannels.map((channel, i) => {
              ...
              return (
                <div
                  ...
                  className={`relative h-16 sm:h-20 rounded-xl sm:rounded-2xl border transition-all duration-300 flex flex-col items-center justify-center p-2.5 sm:p-3 cursor-pointer overflow-hidden ${
                    isHovered
